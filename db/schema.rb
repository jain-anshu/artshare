m.hkjt.o;7 c6il5re strgdfbcgnbvn # This file is auto-generated from the current state of the database. Instead
...
ActiveRecord::Schema[7.0].define(version: 2023_10_08_223915) do
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.index ["artist_id", "title"], name: "artist_id_title_index", unique: true
  end
